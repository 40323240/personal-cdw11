...
b40323240 = Blueprint('b40323240', __name__, url_prefix='/b40323240', template_folder='templates')
...
@b40123250.route('/circle')
def drawcircle():
    return head_str + chain_str + circle(0, 0) + tail_str
 
 
@b40123250.route('/circle1/<degree>', defaults={'x': 0, 'y': 0})
@b40123250.route('/circle1/<x>/<degree>', defaults={'y': 0})
@b40123250.route('/circle1/<x>/<y>/<degree>')
...
@b40123250.route('/circle2/<degree>', defaults={'x': 0, 'y': 0})
@b40123250.route('/circle2/<x>/<degree>', defaults={'y': 0})
@b40123250.route('/circle2/<x>/<y>/<degree>')
...
@b40123250.route('/twocircle/<x>/<y>')
@b40123250.route('/twocircle', defaults={'x':0, 'y':0})
def drawtwocircle(x,y):
    return head_str + chain_str + twocircle(int(x), int(y)) + tail_str
 
 
@b40123250.route('/eighteenthirty/<x>/<y>')
@b40123250.route('/eighteenthirty', defaults={'x':0, 'y':0})
def draweithteenthirdy(x,y):
    return head_str + chain_str + eighteenthirty(int(x), int(y)) + tail_str
 
 
@b40123250.route('/snap')
