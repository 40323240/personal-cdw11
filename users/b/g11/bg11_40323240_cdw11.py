...
bg11_40323240_cdw11 = Blueprint('bg11_40323240_cdw11', __name__, url_prefix='/bg11_40323240_cdw11', template_folder='templates')
...
@bg11_40323240_cdw11.route('/circle')
def drawcircle():
    return head_str + chain_str + circle(0, 0) + tail_str
 
 
@bg11_40323240_cdw11.route('/circle1/<degree>', defaults={'x': 0, 'y': 0})
@bg11_40323240_cdw11.route('/circle1/<x>/<degree>', defaults={'y': 0})
@bg11_40323240_cdw11.route('/circle1/<x>/<y>/<degree>')
#@b40123250.route('/circle1/<int:x>/<int:y>/<int:degree>')
def drawcircle1(x,y,degree):
    return head_str + chain_str + circle1(int(x), int(y), int(degree)) + tail_str
 
 
@bg11_40323240_cdw11.route('/circle2/<degree>', defaults={'x': 0, 'y': 0})
@bg11_40323240_cdw11.route('/circle2/<x>/<degree>', defaults={'y': 0})
@bg11_40323240_cdw11.route('/circle2/<x>/<y>/<degree>')
#@b40123250.route('/circle2/<int:x>/<int:y>/<int:degree>')
def drawcircle2(x,y,degree):
    return head_str + chain_str + circle2(int(x), int(y), int(degree)) + tail_str
 
 
@bg11_40323240_cdw11.route('/twocircle/<x>/<y>')
@bg11_40323240_cdw11.route('/twocircle', defaults={'x':0, 'y':0})
def drawtwocircle(x,y):
    return head_str + chain_str + twocircle(int(x), int(y)) + tail_str
 
 
@bg11_40323240_cdw11.route('/eighteenthirty/<x>/<y>')
@bg11_40323240_cdw11.route('/eighteenthirty', defaults={'x':0, 'y':0})
def draweithteenthirdy(x,y):
    return head_str + chain_str + eighteenthirty(int(x), int(y)) + tail_str
 
 
@bg11_40323240_cdw11.route('/snap')
...
@bg11_40323240_cdw11.route('/snap_link')
...
@bg11_40323240_cdw11.route('/snap_gear')
def snap_gear():
    outstring = '''
<!DOCTYPE html>
<html>
